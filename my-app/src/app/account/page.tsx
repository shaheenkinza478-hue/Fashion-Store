...
import { 
  ...
  FiShoppingBag, FiStar, FiClock, FiTruck,
  FiAward, FiGift, FiCreditCard, FiMapPin,
  FiBell, FiSettings, FiHelpCircle, FiMail,
  FiPhone, FiCamera, FiEdit2, FiCheckCircle,
  FiTrendingUp, FiDollarSign, FiPercent, FiShield,
  FiGithub, FiTwitter, FiFacebook, FiInstagram,
  FiCalendar, FiTag, FiGift as FiGiftIcon
} from 'react-icons/fi';
...
const AccountPage = () => {
  ...
  // If not logged in, show enhanced login/register form
  if (!isLoggedIn) {
    return (
                ...
                <form onSubmit={handleLogin}>
                  <div className="mb-4 animate-slide-in-left animation-delay-100">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-pink-500 text-white placeholder-gray-400 transition-all duration-300 hover:border-pink-400"
  ...
  // Logged in view with 9 sections
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      {/* Animated Background */}
      <div className="absolute inset-0 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 py-12">
        {/* ============================================ */}
        {/* SECTION 1: Welcome Header with Animation */}
        {/* ============================================ */}
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              ...
              >
                ...
                <FiGiftIcon className="text-2xl text-pink-400 group-hover:scale-125 group-hover:rotate-12 transition-all duration-300 cursor-pointer" />
                {showCoupon && (
                  <div className="absolute top-10 right-0 bg-gray-800 border border-pink-500 rounded-lg p-3 w-48 animate-scale-in">
        ...
        {/* ============================================ */}
        {/* SECTION 2: Stats Cards with Hover Animations */}
        {/* ============================================ */}
        ...
        {/* ============================================ */}
        {/* SECTION 3: Currency & Preferences - NEW! */}
        {/* ============================================ */}
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-3 space-y-6">
            {/* ============================================ */}
            {/* SECTION 5: Dashboard Tab with Activity */}
            {/* ============================================ */}
            {activeTab === 'dashboard' && (
            ...
            {/* ============================================ */}
            {/* SECTION 6: Orders Tab with Timeline */}
            {/* ============================================ */}
            {activeTab === 'orders' && (
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 animate-scale-in">
                <h2 className="font-montserrat text-2xl font-bold mb-6 text-white flex items-center gap-2">
            ...
            {/* ============================================ */}
            {/* SECTION 7: Wishlist Tab with Hover Effects */}
            {/* ============================================ */}
            {activeTab === 'wishlist' && (
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 animate-scale-in">
                <h2 className="font-montserrat text-2xl font-bold mb-6 text-white flex items-center gap-2">
            ...
            {/* ============================================ */}
            {/* SECTION 8: Profile Settings with Edit Mode */}
            {/* ============================================ */}
            {activeTab === 'profile' && (
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 animate-scale-in">
            ...
            {/* ============================================ */}
            {/* SECTION 11: Notifications Tab - NEW! */}
            {/* ============================================ */}
